...
MirrorMe! is an easy to learn brain training game based on symmetry. See the pattern on one side, 
and recreate its mirror image on the other side. Think, click and go. The game will not only make
you look and think twice, but force you to adapt to different situations.
...
4. Restriction
DO NOT open the index.html file in Chrome directly. Due to Google Chrome's security restriction,
the mouse events in game won't fully function in Chrome locally. Please run the demo site instead.
